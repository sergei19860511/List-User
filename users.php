    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <div class="row" id="js-contacts">
            <?php foreach ($users as $user):
                $statusUser = getStatusUser($user['id']);
                ?>
            <div class="col-xl-4">
                    ...
                    <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                        <div class="d-flex flex-row align-items-center">
                            ...
                            <div class="info-card-text flex-1">
                                ...
                                <? endif; ?>
                                <span class="text-truncate text-truncate-xl"><?= $user['jobs'] ?></span>
                            </div>
                    ...
                    <div class="card-body p-0 collapse show">
                        <div class="p-3">
                            ...
                            <div class="d-flex flex-row">
                                <a href="<?= empty($user['vk']) ? '#' : $user['vk'] ?>" target="_blank" class="mr-2 fs-xxl" style="color:#4680C2">
                                    <i class="fab fa-vk"></i>
                                </a>
                                <a href="<?= empty($user['telegram']) ? '#' : $user['telegram'] ?>" target="_blank" class="mr-2 fs-xxl" style="color:#38A1F3">
                                    <i class="fab fa-telegram"></i>
                                </a>
                                <a href="<?= empty($user['instagram']) ? '#' : $user['instagram'] ?>" target="_blank" class="mr-2 fs-xxl" style="color:#E1306C">
